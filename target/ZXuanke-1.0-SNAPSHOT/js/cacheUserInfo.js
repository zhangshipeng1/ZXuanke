layui.config({
    ...
    if(window.sessionStorage.getItem('userFace')){
        $("#userFace").attr("src",window.sessionStorage.getItem('userFace')+"?data="+ new Date() + Math.floor(Math.random()*24));
        $(".userAvatar").attr("src",window.sessionStorage.getItem('userFace')+"?data="+ new Date() + Math.floor(Math.random()*24));
    }else{
