...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        String appId = "83EM33P58GvcPo2rTrWi2Ai3Wf4CMC3YB2XEjGPVEpsB";
        String sdkKey = "7Z423EZBQ2oM6Za9vnCPULoVMueYTGnz9YStP6ebcdci";

        FaceEngine faceEngine = new FaceEngine("C:\\Users\\zsp\\Desktop\\ArcSoft_ArcFace_Java_Windows_x64_V2.2\\libs\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("C:\\IMG_20191211_212826.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("C:\\Users\\zsp\\Pictures\\Camera Roll\\3d27e7953ce3d2437c484e2c0d4ea2cf.jpg"));
  ...
  */ 
     ...
     /*   assertEquals("性别检测失败", genderCode, ErrorInfo.MOK.getValue());*/
      ...
      /*  assertEquals("年龄检测失败", ageCode, ErrorInfo.MOK.getValue());*/
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("C:\\IMG_20191211_212826.jpg"));
